<%-- 
    Document   : SubmittedPostByCollaborator
    Created on : Oct 18, 2017, 10:17:57 PM
    Author     : KietPT
--%>
...
<html>
    <head>
        ...
        <title>Save Draft Post Collaborator</title>
                        ...
                        <div class="col-md-4 search">
                            <form action="MainController" method="Post">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="subActionPost" value="saveDraftPostCo"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="MainController" method="Post">
                                                ...
                                                <!-- dùng dể lưu giá trị Search-->
                                                <input type="hidden" value="${lastSearch}" name="txtSearch"/>

                                                <input type="hidden" name="txtUserId" value="${sessionScope.COLLABORATOR.userId}"/>

                                                <!--dùng cho nút View của của trang SaveDraft-->
                                                <input type="hidden" name="subView" value="saveDraftPostCoDetail"/>
