<%-- 
    Document   : RejecttedPostModerator
    Created on : Oct 18, 2017, 4:32:48 PM
    Author     : KietPT
--%>
...
<html>
    <head>
        ...
        <title>Sent Post Moderator</title>
        ...
        <div class="container abody">
            <div class="row">
                <div class="col-md-3 list-group menu">
                    ...
                    <a href="RejecttedPostModerator.jsp" class="list-group-item active">Rejected Post</a>
                </div>
                <div class="col-md-9 rightBody">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 id="add">REJECTED POST</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 search">
                            <form action="MainController" method="Post">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="subActionPost" value="rejectedPostMo"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="MainController" method="Post">
                                                ...
                                                <input type="hidden" value="rejectedPostMoDetail" name="subView"/>
