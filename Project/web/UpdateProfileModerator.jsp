<%-- 
    Document   : UpdateProfileModerator
    Created on : Oct 18, 2017, 4:36:13 PM
    Author     : KietPT
--%>
        ...
        <div class="container abody">
            <div class="row">
                <div class="col-md-3 list-group menu">
                    <a href="UpdateProfileModerator.jsp" class="list-group-item active">Profile</a>
                        ...
                        <div class="col-md-12 profile">
                            <form class="form-horizontal" action="MainController" method="Post">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="userName" placeholder="Enter UserName" name="txtUserId" value="${sessionScope.MODERATOR.userId}" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="fullName">Full Name:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="fullName" placeholder="Enter FullName" name="txtFullname" value="${sessionScope.MODERATOR.fullname}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="birthday" name="txtBirthday" value="<fmt:formatDate pattern='yyyy-MM-dd' value='${sessionScope.MODERATOR.birthday}'/>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="radio-inline">
                                            <input type="radio" name="radioSex" value="Male" ${sessionScope.MODERATOR.sex eq 'True' ? 'checked': ''}>Male
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="radioSex" value="Female" ${sessionScope.MODERATOR.sex eq 'False' ? 'checked': ''}>Female
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="phone" placeholder="Enter Phone Number" name="txtPhone" value="${sessionScope.MODERATOR.phone}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="email" placeholder="Enter Email" name="txtEmail" value="${sessionScope.MODERATOR.mail}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="address" placeholder="Enter Address" name="txtAddress" value="${sessionScope.MODERATOR.address}" required>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <input type="hidden" name="subAction" value="UpdateProfileModer"/>
