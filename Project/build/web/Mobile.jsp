                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="Mobile.jsp">Mobile</a></li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <ducnh:if test="${empty sessionScope.READER}">
                                    ...
                                    <li><a href="logintp.jsp?page=mobile"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
                                    </ducnh:if>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-9">
                    <%
                        ...
                        List<PostDTO> list = dao.showMobile();
                        if (list != null) {
