<%-- 
    Document   : SubmittedPostCollaborator
    Created on : Oct 18, 2017, 10:35:26 PM
    Author     : KietPT
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Sent Post Collaborator</title>
                        ...
                        <div class="col-md-4 search">
                            <form action="MainController" method="Post">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" value="submittedPostCo" name="subActionPost"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="MainController" method="Post">
                                                ...
                                                <input type="hidden" name="subView" value="submittedPostCoDetail"/>
