...
public class ViewDetailAccountController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String userIdBeClicked = request.getParameter("txtUserIdBeClicked");
            dto = dao.findByUserID(userIdBeClicked);
            request.setAttribute("AccountDetails", dto);
            url = "SetRoleAndBan.jsp";
        } catch (Exception e) {
            log("ERROR at ViewDetailAccountController: " + e.getMessage());
        } finally {
