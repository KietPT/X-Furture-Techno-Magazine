 ...
 * @author KietPT
 */
public class UpdateProfileCollaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (address.equals("")) {
                ...
                error.setErrorAddr("Address can't be blank! and have 10-11 digits ");
                check = false;
            }
            ...
            log("ERROR at UpdateProfileCollaController: " + e.getMessage());
        } finally {
